from PyQt5.QtWidgets import (
    ...
    QDialog, QFormLayout, QLineEdit, QComboBox, QMessageBox, QHeaderView, QLabel, QDialogButtonBox
)
import sqlite3
...
class SalasTab(QWidget):
    ...
    def excluir_sala(self):
        ...
        row = selected[0].row()
        sala_id = int(self.table.item(row, 0).text())
        resposta = QMessageBox.question(self, "Confirmar exclusão", "Deseja excluir esta sala?", QMessageBox.Yes | QMessageBox.No)
